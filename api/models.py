...
class InvoicePayment(models.Model):
    ...
    amount_receive = models.CharField(max_length=255, blank=True, null=True)
...
class WalletPharmacie(models.Model):
    ...
    def __str__(self):
        return f"Wallet de la pharmacie {self.pharmacie}"
...
class  WalletPharmacieHistory(models.Model):
    wallet = models.ForeignKey(WalletPharmacie, on_delete=models.CASCADE, related_name='wallet_pharmacie_history')
    action_type = models.CharField(max_length=255, choices=TYPE_CHOICES)
