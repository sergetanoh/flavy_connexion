...
def transfer_money(pharmacie, invoice):
    ...
    token = generateToken()
    # token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJjb21wYW55SWQiOiI4MWU1OGEyOC0wMWExLTQ3YTMtOTAzYy0yNTdkNDE4ZmNlNzEiLCJpYXQiOjE3Mzg2ODkyNzYsImV4cCI6MTczODY4OTg3Nn0.kkEFxYCRZFDJEsajtTmZGw4qH3X6BxK_jGxoKvqVlf0"
    if token == "":
